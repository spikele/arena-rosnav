...
def main(agent_name: str, obs_topic: str) -> None:
    AGENT = DeploymentRecordAgent(agent_name=agent_name, obs_topic=obs_topic, ns=NS_PREFIX)
...
if __name__ == "__main__":
    ...
    OBS_TOPIC = sys.argv[2]
    main(agent_name=AGENT_NAME, obs_topic=OBS_TOPIC)
