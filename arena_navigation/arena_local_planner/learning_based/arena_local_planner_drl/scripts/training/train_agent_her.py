...
from stable_baselines3 import PPO, TD3, HerReplayBuffer
...
def main():
    ...
    eval_cb = EvalCallback(
        ...
        train_env=env,
        n_eval_episodes=100,
        eval_freq=15000*4,    # seems like agent is actually evaluated every eval_freq * n_envs steps, so for her (1 env) use *4
        log_path=PATHS["eval"],
