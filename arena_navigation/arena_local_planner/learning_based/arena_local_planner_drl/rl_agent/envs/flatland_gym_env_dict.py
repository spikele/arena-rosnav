...
class FlatlandDictEnv(gym.Env):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super(FlatlandDictEnv, self).__init__()
    ...
    def _update_eval_statistics(self, obs_dict: dict, reward_info: dict):
        ...
        if self._last_robot_pose is not None:
            self._distance_travelled += FlatlandDictEnv.get_distance(self._last_robot_pose, obs_dict["robot_pose"])
